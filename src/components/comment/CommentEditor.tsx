      ...
      <div className="rounded-[20px] bg-card">
        <div
          className={cn(
            ...
            "[&_.ql-editor.ql-blank::before]:left-5 [&_.ql-editor.ql-blank::before]:right-5 [&_.ql-editor.ql-blank::before]:text-sm [&_.ql-editor.ql-blank::before]:text-muted-foreground [&_.ql-editor.ql-blank::before]:not-italic",
          )}
        >
