  ...
  return (
    <div className="top-header px-10 z-10 sticky bg-card border-t-border border-t">
      <div className="flex items-center h-14 space-x-4">
        ...
        <div className="flex-1 h-full relative">
          <div className="flex items-center h-full flex-1">
            <div className="flex items-center hover:text-primary cursor-pointer">
              ...
              <span className="text-secondary ml-1 text-sm">{t("posts")}</span>
              <span className="mx-3 text-[#eceff4]">/</span>
            </div>
            <div className="flex items-center hover:text-primary cursor-pointer">
              <span className="text-[22px]">{tag.followCount || 0}</span>
              <span className="text-secondary ml-1 text-sm">{t("members")}</span>
            </div>
          </div>
        ...
        <div
          className={cn(
            "flex items-center space-x-3 relative transition-all",
        ...
        >
          ...
          >
            <span className="text-xs">
              {isLoading ? "..." : isFollowed ? tButton("following") : tButton("follow")}
            </span>
          </Button>
        </div>
      </div>
